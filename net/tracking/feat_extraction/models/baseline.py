...
model_urls = {
    'resnet50': '/data/2/rpfei/open_VehicleReID_master/pretrained_models/resnet50-19c8e357.pth',
}
...
class Baseline(nn.Module):
    ...
    def __init__(self, num_classes, last_stride=1, pretrained=False):
        ...
        self.fc = nn.Linear(self.in_planes, self.num_classes, bias=False)#first 
